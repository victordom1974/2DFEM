% P1_FEM_test  Test script for the P1 FEM code (Helmholtz equation).
%
%   This script runs a basic finite element experiment for the modified
%   Helmholtz problem
%
%        Delta u + c u = f   in Omega,
%
%   with mixed boundary conditions (Dirichlet and/or Neumann).
%   It assembles the stiffness and mass matrices, builds the right-hand side,
%   enforces Dirichlet data, solves the linear system, and optionally plots
%   the numerical solution and the nodal error.
%
...
%     Optionally, a uniform refinement step can be applied with refineGrid.
%
%   Options:
...
%     loadMesh, refineGrid,
%     FEMMassMatrix, FEMStressMatrix,
%     FEMLoadVector, FEMTractionVector.
%
...
M = FEMNonConstantMassMatrix( FEMmesh,@(x,y,dom)x*0+y*0+1);
